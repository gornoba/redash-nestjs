...
export class CreateRedashInitialSchema1741591000000 implements MigrationInterface {
  name = 'CreateRedashInitialSchema1741591000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE INDEX "IDX_query_results_query_hash" ON "query_results" ("query_hash")
    `);
    ...
    await queryRunner.query(`
      CREATE INDEX "IDX_queries_is_archived" ON "queries" ("is_archived")
    `);

    await queryRunner.query(`
      CREATE INDEX "IDX_queries_is_draft" ON "queries" ("is_draft")
    `);

    await queryRunner.query(`
      CREATE INDEX "IDX_queries_search_vector" ON "queries" USING GIN ("search_vector")
    `);
    ...
    await queryRunner.query(`
      CREATE INDEX "IDX_dashboards_is_archived" ON "dashboards" ("is_archived")
    `);

    await queryRunner.query(`
      CREATE INDEX "IDX_dashboards_is_draft" ON "dashboards" ("is_draft")
    `);
    ...
    await queryRunner.query(`
      CREATE INDEX "api_keys_object_type_object_id" ON "api_keys" ("object_type", "object_id")
    `);
    ...
    await queryRunner.query(`
      CREATE UNIQUE INDEX "notification_destinations_org_id_name" ON "notification_destinations" ("org_id", "name")
    `);
    ...
    await queryRunner.query(`
      CREATE UNIQUE INDEX "alert_subscriptions_destination_id_alert_id" ON "alert_subscriptions" ("destination_id", "alert_id")
    `);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP TABLE "query_snippets"`);
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_api_keys_api_key"`);
    await queryRunner.query(`DROP TABLE "api_keys"`);
    await queryRunner.query(`DROP TABLE "events"`);
    await queryRunner.query(`DROP TABLE "alerts"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_widgets_dashboard_id"`);
    await queryRunner.query(`DROP TABLE "widgets"`);
    await queryRunner.query(`DROP TABLE "visualizations"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_dashboards_is_draft"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_dashboards_is_archived"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_dashboards_slug"`);
    await queryRunner.query(`DROP TABLE "dashboards"`);
    await queryRunner.query(`DROP TABLE "favorites"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_queries_search_vector"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_queries_is_draft"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_queries_is_archived"`);
    await queryRunner.query(`DROP TABLE "queries"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_query_results_query_hash"`,
    );
    await queryRunner.query(`DROP TABLE "query_results"`);
    await queryRunner.query(`DROP TABLE "data_source_groups"`);
    await queryRunner.query(`DROP INDEX "public"."data_sources_org_id_name"`);
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_users_org_id_email"`);
